...
const awsClient = supabase; // Maintain internal reference

// Verification check
if (supabase) {
    console.log('🚀 Supabase Data Services: Connected (v2.x)');
}
...
async function addCollege(userIdOrObject, name = null, type = null, major = null) {
